...
frappe.ready(function() {
	$('#submit').off("click").on("click", function(e) {
		...
		let data = JSON.parse(localStorage.getItem('frappe-web-form'))
		localStorage.removeItem('frappe-web-form')
		stripe.createToken(card, extraDetails).then(r => {
			r.payer_name = extraDetails.name
			r.payer_email = extraDetails.email
			r.currency = "USD"
